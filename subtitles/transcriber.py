...
model_path = "C:/Program Files/vosk-model-en-us-0.22"
...
if __name__ == '__main__':
    ...
    if use_existing == 'n':
        ...
        transcribe_to_subs(f'C:/Users/ryana/Documents/VsCode/VideoGenerator/musicaption-master/inputs/audios/{audio_file_name}.wav')
    else:
